...
const MESSAGE_DRAG_ONTO_CALLING = "Drop member on the shaded area of the calling.";
const MESSAGE_DELETE_IMAGE_DRAG_FROM_MEMBER = "To delete a photo, drag it from the member record.";
const MESSAGE_MODEL_LOADED = "Model loaded";
const MESSAGE_MODEL_MERGED = "Model merged";
